        ...
        async with self._trace_repositories_provider() as trace_repositories:
            ...
            async with self._repositories_provider() as repositories:
                ...
                initial_state: AgentState = {
                    ...
                    # known_patient_name (returning-contact greeting) needs
                    # PatientGateway.get_patient_by_id wiring — provisionally
                    # None so the greeting falls back to the generic one.
                ...
                if (
                    ...
                    # location message carries no text of its own, so its
                    # presence alone is enough to know there's something to
                    # send.
                    return
