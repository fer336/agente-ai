...
class ChatwootMessageCreatedPayload(BaseModel):
    ...
    def to_inbound_message_dto(self) -> InboundMessageDTO:
        ...
        method does not re-check them. `sender.phone_number` has no silent
        default: a missing value raises explicitly rather than producing a
        DTO with a fabricated phone number.
        """
