...
DEFAULT_GENERATE_RESPONSE_PROMPT = (
    ...
    "profesional ni horario en tu texto, ni con viñetas ni de ninguna otra forma — ni uno solo, "
    "aunque te parezca más natural o servicial completarlo. Ante la duda, escribí menos, "
    "nunca de más. "
