...
class ConformingScheduledActionRepository:
    ...
    async def get_scheduled_by_conversation_id(self, conversation_id):
        return []
...
class MissingGetScheduledByConversationIdRepository:
    async def get_by_id(self, scheduled_action_id):
        return None
...
def test_class_missing_get_scheduled_by_conversation_id_does_not_satisfy_protocol():
    assert not isinstance(
        MissingGetScheduledByConversationIdRepository(), ScheduledActionRepository
    )
